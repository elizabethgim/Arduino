...
// adjust servo position according to the USS read value
  ...
  // add your code here!
  /*
   if(dist_ema < 180) myservo.writeMicroseconds(_DUTY_MIN);
   else if(dist_ema <190) myservo.writeMicroseconds(553+(dist_ema-180)*5);
   else if(dist_ema <360) myservo.writeMicroseconds((dist_ema-180)*13);
   else myservo.writeMicroseconds(_DUTY_MAX);
   */

   if(dist_ema < 180) myservo.write(_DUTY_MIN);
   else if(dist_ema < 360) myservo.write(dist_ema-180);
   else myservo.write(_DUTY_MAX);
